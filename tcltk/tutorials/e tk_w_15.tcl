...
proc TextExample { f } {
	...
	$t tag configure para -spacing1 0.25i -spacing2 0.1i -lmargin1 0.5i \
		-lmargin2 0.1i -rmargin 0.5i
	$t tag configure hang -lmargin1 0.1i -lmargin2 0.5i

	$t insert end "Here is a line woth no special settings\n"
	$t insert end "Now is the time for all good women and men to come to the aid of theirs country. In this great time of need, no one can avoid their responsibility.\n"
